import { builds } from "@/data/builds/builds";
import {
  formatObjectDimensions,
  getGameObjectDetails,
} from "@/data/game/objectDetails";
...
import { mods } from "@/data/mods/mods";
import { quests } from "@/data/quests/quests";
import type { ArticleEntry, ToolEntry, WikiEntry } from "@/data/types";
import { tools } from "@/data/tools/tools";
import { updates } from "@/data/updates/updates";
import { blockEntries } from "@/data/wiki/blocks";
import { cropBotRoutes } from "@/data/wiki/botGuide";
import { botEntries } from "@/data/wiki/bots";
import { wikiCategories as rawWikiCategories } from "@/data/wiki/categories";
import { cropEntries } from "@/data/wiki/crops";
import { getWikiEntryAliases } from "@/data/wiki/entryAliases";
import { consumableRewardEntries } from "@/data/wiki/consumableRewards";
import { garmentEntries } from "@/data/wiki/garments";
import { itemEntries } from "@/data/wiki/items";
import { interactiveRewardEntries } from "@/data/wiki/interactiveRewards";
import { industrialPartEntries } from "@/data/wiki/industrialParts";
import { partEntries } from "@/data/wiki/parts";
import { questRewardEntries } from "@/data/wiki/questRewards";
import { resourceEntries } from "@/data/wiki/resources";
import { schematicEntries } from "@/data/wiki/schematics";
import { toolWikiEntries } from "@/data/wiki/tools";
import { miningEntries } from "@/data/wiki/mining";
import { weaponEntries } from "@/data/wiki/weapons";
